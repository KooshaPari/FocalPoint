    ...
    pub fn map_activities(&self, activities: Vec<Activity>) -> Vec<NormalizedEvent> {
        ...
        for activity in activities {
            ...
            events.push(NormalizedEvent {
                ...
                connector_id: "strava".to_string(),
                account_id: self.account_id,
                event_type: EventType::Custom("strava:activity_completed".to_string()),
            ...
            if let Some(pr_count) = activity.pr_count {
                if pr_count > 0 {
                    ...
                    events.push(NormalizedEvent {
                        ...
                        connector_id: "strava".to_string(),
                        account_id: self.account_id,
                        event_type: EventType::Custom("strava:pr_earned".to_string()),
                        occurred_at: started_at,
                        effective_at: Utc::now(),
...
mod tests {
    ...
    fn map_activities_to_events() {
        ...
        let activities = vec![crate::models::Activity {
            ...
            start_date: "2026-04-23T19:30:00Z".to_string(),
            start_date_local: "2026-04-23T15:30:00".to_string(),
            distance: 5000.0,
            moving_time: 1800,
            elapsed_time: 1850,
            elevation_gain: 50.0,
            type_: Some("Run".to_string()),
    ...
    fn map_pr_earned_to_events() {
        ...
        let activities = vec![crate::models::Activity {
            ...
            sport_type: "Run".to_string(),
            start_date: "2026-04-23T07:00:00Z".to_string(),
            start_date_local: "2026-04-23T03:00:00".to_string(),
            distance: 10000.0,
            moving_time: 2400,
            elapsed_time: 2450,
    ...
    fn dedupe_key_generation() {
        ...
        let activity = crate::models::Activity {
            ...
            start_date: "2026-04-23T12:00:00Z".to_string(),
            start_date_local: "2026-04-23T08:00:00".to_string(),
            distance: 30000.0,
            moving_time: 3600,
            elapsed_time: 3700,
            elevation_gain: 200.0,
            type_: Some("Ride".to_string()),
    ...
    fn multiple_prs_single_activity() {
        ...
        let activities = vec![crate::models::Activity {
            id: 55555555,
            name: "Personal Best Effort".to_string(),
            sport_type: "Run".to_string(),
            start_date: "2026-04-23T06:00:00Z".to_string(),
            start_date_local: "2026-04-23T02:00:00".to_string(),
            distance: 5000.0,
            moving_time: 1500,
            elapsed_time: 1550,
            elevation_gain: 25.0,
