...
- `USAGE.md` â€” Complete adoption guide with patterns and workarounds
- `../focus-eval` â€” `Result<T, E>` variant example
- `../focus-rituals` â€” `anyhow::Result<T>` variant example
